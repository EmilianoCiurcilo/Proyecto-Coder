...
function agregarAlCarrito(idProducto) {
    ...
    //      undefined                      0               0
    let alfajorEnCarrito = carrito.find((alfajor) => alfajor.id === idProducto);
    ...
    if (alfajorEnCarrito) {
        ...
        // el objeto
        let cantidad = 1;
        carrito.push(new Alfajor(alfajores[idProducto], cantidad));
    }
